...
if (!( 'Raganork~b5a5a27dba8856a93a351344e8cfddb2:4f2f493735524e75734c493d' || process.env.SESSION_ID)) throw new Error("No session found, add session before starting bot")
module.exports = {
    VERSION: 'v4.0.0',
